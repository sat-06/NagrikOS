  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "NagrikOS — AI Civic Action Agent" },
      {
        ...
        content: "Turn everyday civic confusion into clear, trackable action journeys.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Fraunces:opsz,wght@9..144,500;9..144,600;9..144,700&family=Noto+Sans+Devanagari:wght@400;500;600;700&display=swap",
      },
    ],
  }),
