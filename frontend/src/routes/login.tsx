...
export const Route = createFileRoute("/login")({
  head: () => ({ meta: [{ title: "Sign in — NagrikOS" }, { name: "description", content: "Sign in to your NagrikOS civic action space." }] }),
  component: LoginPage,
});
    ...
    <div className="grid min-h-dvh lg:grid-cols-2">
        ...
        <div className="absolute inset-0 p-10 text-primary-foreground">
          ...
          <div className="mt-24 max-w-md">
            ...
            <p className="mt-4 text-primary-foreground/80">
              Sign in to continue your civic missions, follow up on complaints, and get
              personalised opportunity matches.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center bg-background px-4 py-10">
        <Card className="w-full max-w-md p-6 shadow-card">
          ...
          <p className="mt-1 text-sm text-muted-foreground">Use the demo credentials or your own values — this is a frontend demo.</p>
