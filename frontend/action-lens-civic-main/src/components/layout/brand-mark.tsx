  ...
  return (
    <div className={cn("flex items-center gap-2", className)}>
      ...
      <div className="leading-tight">
        <div className="font-display text-lg font-bold tracking-tight">NagrikOS</div>
        <div className="text-[10px] uppercase tracking-[0.14em] text-muted-foreground">Civic Action Agent</div>
      </div>
    </div>
  );
}
